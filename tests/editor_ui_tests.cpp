...
int main() {
    ...
    if(!editor.set_ui_locale("zh-CN")||editor.ui_locale()!="zh-CN"||editor.set_ui_locale("../host-locale")||
       editor.ui_locale()!="zh-CN"||
    ...
    if(!editor.set_ui_locale("en-US")||editor.ui_locale()!="en-US")return 59;
